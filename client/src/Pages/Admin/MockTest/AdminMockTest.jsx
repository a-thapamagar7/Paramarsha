...
const AdminMockTest = () => {
  ...
  const getQuestions = async () => {
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/getquestioninfo`,
      {
        method: "GET",
        headers: {
  ...
  const deleteQuestions = async (questionId) => {
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/question/delete/${questionId}`,
      {
        method: "DELETE",
        headers: {
          "Content-Type": "application/json",
  ...
  const editQuestions = async (questionId) => {
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/question/update/${questionId}`,
      {
        method: "PATCH",
        headers: {
          "Content-Type": "application/json",
  ...
  const createQuestions = async () => {
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/question/create`,
      {
        method: "POST",
            ...
            {question.map((value, index) => {
              return !editPressed || value._id != identifyID ? (
                ...
                >
                  ...
                  <td className="col-span-4 overflow-hidden overflow-ellipsis whitespace-nowrap max-w-full">
                    {value.question}
                  </td>
                  <td className="col-span-1 overflow-hidden overflow-ellipsis whitespace-nowrap max-w-full">
                    {value.subject}
                  </td>
                  <td className="col-span-1 overflow-hidden overflow-ellipsis whitespace-nowrap max-w-full">
                    {value.answer}
                  ...
                  <td
                    key={index + "jk"}
                    className="col-span-1 overflow-hidden overflow-ellipsis whitespace-nowrap max-w-full"
                  >
                    {value.options[0] || ""}
                  </td>
                  <td
                ...
                >
                  <td className="col-span-1">{index + 1}</td>
                  <td className="col-span-4 w-full h-full border-r">
                    <input
