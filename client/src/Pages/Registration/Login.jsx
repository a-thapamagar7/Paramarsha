...
const Login = () => {
  ...
  return (
    <div className="loginBG items flex lg:h-screen justify-center items-center">
      <ToastContainer />
        ...
        <div className="flex ml-16 flex-col justify-center">
          <div className="w-64">
            ...
            <form className="flex flex-col text-sm" onSubmit={loginUser}>
              <input
                required
                className="inputBorder mb-1 w-full register-login-font spacegrotesk"
                type="email"
                value={email}
              ...
              <br />
              <div
                className="w-28 spacegrotesk mb-5 underline cursor-pointer"
                style={{ fontSize: "11px" }}
              >
                Forgot Password
              </div>
              <button
                type="submit"
                className="spacegrotesk text-xs bg-black text-white w-full h-9 rounded-sm"
              >
                Log in
              </button>
            </form>
