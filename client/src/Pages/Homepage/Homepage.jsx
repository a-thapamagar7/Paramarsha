    ...
    <>
      <div className="px-10 lg:px-20">
        ...
        <div className="mt-20">
          ...
          <div className="w-full grid grid-cols-12 gap-x-12 gap-y-10 pt-10">
            <Features
              link="/test"
              name="Mock Tests"
            ...
            <Features
              link="/quiz"
              name="Quiz"
              details="User will be able to take a quiz which will be able to recommend students a course which may be suitable for them according to our system."
              image={quiz}
            />
            <Features
              link="/content/colleges"
              name="Review System"
              details="User will be able rate the rate the colleges on the basis of different factors which will be later rounded to give an overall rating."
              image={review}
            />
            <Features
              link="/content/all"
              name="Colleges and Courses"
              details="User will be able to access information about the vast number of colleges, courses and univesities of Nepal."
              image={college}
            />
          </div>
        </div>
