                ...
                <div className="flex ml-16 flex-col justify-center">
                    <div className="w-64">
                        ...
                        <form className="flex flex-col gap-y-4 text-sm" onSubmit={registerUser}>
                            <input required className="inputBorder w-full register-login-font spacegrotesk" type="text" value={fName} onChange={(e) => setFName(e.target.value)} placeholder="First Name" />
                            <input required className="inputBorder w-full register-login-font spacegrotesk" type="text" value={lName} onChange={(e) => setLName(e.target.value)} placeholder="Last Name" />
                            <input required className="inputBorder w-full register-login-font spacegrotesk" type="email" value={email} onChange={(e) => setEmail(e.target.value)} placeholder="Email" />
                            <input required className="inputBorder w-full register-login-font spacegrotesk" type="password" value={password} onChange={(e) => setPassword(e.target.value)} placeholder="Password" />
                            <input required className="inputBorder w-full register-login-font spacegrotesk" type="password" placeholder="Confirm Password" />
